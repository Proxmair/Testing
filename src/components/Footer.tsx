        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            ...
            <p className="text-gray-300 mb-4">
              Your partner in achieving fitness goals and maintaining a healthy lifestyle.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#workouts" className="text-gray-300 hover:text-white transition duration-300">Workouts</a></li>
              <li><a href="#nutrition" className="text-gray-300 hover:text-white transition duration-300">Nutrition</a></li>
          ...
          <div>
            ...
            <p className="text-gray-300 mb-4">
              Get the latest fitness tips, nutrition advice, and exclusive offers.
            </p>
            <form onSubmit={handleSubmit}>
              <div className="flex flex-col sm:flex-row">
                <input 
                  ...
                  className="px-4 py-2 w-full sm:w-auto rounded-md mb-2 sm:mb-0 sm:mr-2 text-gray-800 focus:outline-none focus:ring-2 focus:ring-green-500" 
                  required
                />
                <button 
                  type="submit"
